...
public class Utils {
    ...
    public static final String PIZZA_6_TITLE = "Sourdough pizza";
    public static final String PIZZA_6_DESCRIPTION = "Make homemade sourdough pizza with a wonderfully chewy crust. Try our margherita recipe, then customise with your favourite toppings";
    public static final String PIZZA_6_RECIPE = "Make a batch of our white sourdough, following the recipe to the end of step 4. When the dough is ready, tip it onto a lightly floured surface and divide into six equal pieces. Roll into balls and leave to rest on a floured tray, covered with a damp teatowel, in the fridge for at least 4 hrs, and up to 18 hrs – the longer you leave the dough, the more sour it will taste.\n" +
            "\n" +
    ...
    public static final String PIZZA_7_TITLE = "Ultimate pizza Margherita";
    public static final String PIZZA_7_DESCRIPTION = "Take your senses on a trip to Italy with this authentic pizza Margherita";
    public static final String PIZZA_7_RECIPE = "In a bowl, mix flour, semolina, salt and yeast. Make a dip in the middle, pour in oil, water, then stir and squeeze everything together (hands are easiest for this). The dough should feel very sticky (pic 1). When it is well mixed, cover and leave for 15 mins.\n" +
            "\n" +
    ...
    public static final String PIZZA_8_TITLE = "Pizza with homemade sauce";
    public static final String PIZZA_8_DESCRIPTION = "Make pizza for the family with a homemade base and tomato sauce. The recipe is perfect to get kids involved in cooking. Top with mozzarella and fresh basil";
    public static final String PIZZA_8_RECIPE = "Tip the flour into a bowl, then stir in the yeast and 1 tsp salt. Make a well in the centre and pour in 200ml warm water (make sure it’s not too hot) along with the oil. Stir together with a wooden spoon until you have a soft, fairly wet dough.\n" +
            "\n" +
    ...
    public static final String PIZZA_9_TITLE = "Rainbow pizzas";
    public static final String PIZZA_9_DESCRIPTION = "Forget takeaway pizzas, encourage kids to eat a rainbow every day with this colourful recipe full of fresh flavours – guaranteed to please even fussy eaters...";
    ...
    public static final String PIZZA_10_TITLE = "Gluten-free pizza";
    public static final String PIZZA_10_DESCRIPTION = "Make our gluten-free version of a classic pizza. The base is easy, spread over rich homemade tomato sauce, then finish with buffalo mozzarella and fresh basil";
    public static final String PIZZA_10_RECIPE = "Heat the oven to 220C/200 fan/gas 7 and put two baking sheets inside.\n" +
            "\n" +
